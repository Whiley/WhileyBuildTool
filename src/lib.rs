...
use crate::platform::{whiley,quickcheck,javascript,boogie};
...
pub fn init_registry<'a>() -> platform::Registry<'a> {
    ...
    // Register quickcheck platform which is responsible for checking WyIL files.
    r.register("check",&quickcheck::DESCRIPTOR);
